...
module.exports = class DialogView extends View {
  ...
  */
  ...
  initialize(options={}) {
    ...
    this.subscriptions.add(this.saveButton, 'click', evt => this._onSaveClick(evt))
    this.subscriptions.add(this.cancelButton, 'click', evt => this._onCancelClick(evt))
    this.subscriptions.add(this, 'click',  evt => this._onBackdropClick(evt))
  }
