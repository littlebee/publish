...
export default {
  ...
  version(versionMethod = null) {
    ...
    const publishViewProps = {
      ...
      onSave: values => {
        DialogView.unmountDialog(this.publishViewDialog)
        this._onPublish(values)
      },
      onCancel: values => {
        DialogView.unmountDialog(this.publishViewDialog)
      },
  ...
  _onPublish(attributes) {
    const publishProgressViewProps = {
      ...
      _onProgressSave: this._onProgressSave,
    }
    this.publishProgressView = DialogView.renderDialogToDom(
      PublishProgressView, publishProgressViewProps, 'publishProgressView', () => {
  ...
  _updateChangeLog(attributes) {
    ...
    const repoUrl = (this.npmPackage.repository != null ? this.npmPackage.repository.url : undefined) ||
      this.npmPackage.repository
